...
class WebNavigationTests(unittest.TestCase):
    ...
    def test_mobile_router_is_compact_optional_evidence(self):
        ...
        self.assertIn('href=\\"/help/rutx50\\">Open RUTX50 setup help', source)
        self.assertNotIn('onclick=\\"window.close()\\"', source)
        self.assertIn('if route_path == "/help/rutx50":', source)
        self.assertIn("def rutx50_help_html():", source)
