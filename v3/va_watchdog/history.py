...
def append_history(cfg: dict[str, Any], status: dict[str, Any]) -> None:
    ...
    payload = {
        ...
        "mobile_router_rsrp_dbm": mobile_router.get("rsrp_dbm"),
        "mobile_router_rsrq_db": mobile_router.get("rsrq_db"),
        "mobile_router_sinr_db": mobile_router.get("sinr_db"),
        "mobile_router_radio_score": mobile_router.get("radio_score"),
        "mobile_router_radio_score_label": mobile_router.get("radio_score_label"),
        "mobile_router_radio_score_limiting": mobile_router.get("radio_score_limiting"),
        "mobile_router_temperature_c": mobile_router.get("temperature_c"),
        "mobile_router_network_type": mobile_router.get("network_type"),
        "mobile_router_cell_id": mobile_router.get("cell_id"),
        "mobile_router_cell_changed": bool(mobile_router.get("cell_changed", False)),
        "mobile_router_connection_uptime_seconds": mobile_router.get("connection_uptime_seconds"),
        "mobile_router_reconnected": bool(mobile_router.get("mobile_reconnected", False)),
